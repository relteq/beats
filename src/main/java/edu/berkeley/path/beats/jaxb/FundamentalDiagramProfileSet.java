 ...
 *         &lt;element ref="{}fundamentalDiagramProfile" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "FundamentalDiagramProfileSet")
public class FundamentalDiagramProfileSet {

    protected String description;
    protected List<FundamentalDiagramProfile> fundamentalDiagramProfile;
     ...
     * 
     */
    public List<FundamentalDiagramProfile> getFundamentalDiagramProfile() {
        if (fundamentalDiagramProfile == null) {
            fundamentalDiagramProfile = new ArrayList<FundamentalDiagramProfile>();
        }
