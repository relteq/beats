 ...
 *
 */
public abstract class BaseSensorSetsPeer
    extends com.relteq.sirius.db.BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SensorSetsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SensorSetsMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "sensor_sets";

        ID = "sensor_sets.id";
        PROJECT_ID = "sensor_sets.project_id";
        NAME = "sensor_sets.name";
        DESCRIPTION = "sensor_sets.description";
        CREATED = "sensor_sets.created";
        MODIFIED = "sensor_sets.modified";
        CREATED_BY = "sensor_sets.created_by";
        MODIFIED_BY = "sensor_sets.modified_by";
        MODSTAMP = "sensor_sets.modstamp";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SensorSetsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SensorSetsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.relteq.sirius.om.SensorSets";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SensorSets row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SensorSets obj = (SensorSets) cls.newInstance();
            SensorSetsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(SensorSetsPeer.row2Object(row, 1,
                SensorSetsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(SensorSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SensorSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SensorSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SensorSets obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SensorSets) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SensorSets obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SensorSets) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SensorSets obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SensorSets) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SensorSets obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SensorSets obj )
    {
    ...
    public static Criteria buildSelectCriteria( SensorSets obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static SensorSets retrieveByPK(Long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SensorSets retrieveByPK(Long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SensorSets retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SensorSets retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SensorSets retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
    ...
    /**
     * selects a collection of SensorSets objects pre-filled with their
     * Projects objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SensorSetsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(SensorSetsPeer.PROJECT_ID,
            ProjectsPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = SensorSetsPeer.getOMClass();
            SensorSets obj1 = (SensorSets) SensorSetsPeer
            ...
            {
                SensorSets temp_obj1 = (SensorSets) results.get(j);
                Projects temp_obj2 = (Projects) temp_obj1.getProjects();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addSensorSets(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initSensorSetss();
                obj2.addSensorSets(obj1);
            }
            results.add(obj1);
        }
        return results;
