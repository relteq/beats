...
/**
  ...
  *
  */
public class LinkNameMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.LinkNameMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("link_name");
        TableMap tMap = dbMap.getTable("link_name");
        tMap.setJavaName("LinkName");
        tMap.setOMClass( com.relteq.sirius.om.LinkName.class );
        tMap.setPeerClass( com.relteq.sirius.om.LinkNamePeer.class );
