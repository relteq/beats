...
/**
  ...
  *
  */
public class NodeNameMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.NodeNameMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("node_name");
        TableMap tMap = dbMap.getTable("node_name");
        tMap.setJavaName("NodeName");
        tMap.setOMClass( com.relteq.sirius.om.NodeName.class );
        tMap.setPeerClass( com.relteq.sirius.om.NodeNamePeer.class );
