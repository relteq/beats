 ...
 * extended all references should be to EventSets
 */
public abstract class BaseEventSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final EventSetsPeer peer =
        new EventSetsPeer();
    ...
    public void setId(Long v) throws TorqueException
    {
        ...
        if (collEventss != null)
        {
            for (int i = 0; i < collEventss.size(); i++)
            {
                ((Events) collEventss.get(i))
                        .setEventSetId(v);
            }
        }
    ...
    /**
     * Collection to store aggregation of collEventss
     */
    protected List collEventss;

    /**
     * Temporary storage of collEventss to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initEventss()
    {
        if (collEventss == null)
        {
            collEventss = new ArrayList();
        }
    }
     ...
     * @throws TorqueException
     */
    public void addEvents(Events l) throws TorqueException
    {
        getEventss().add(l);
        l.setEventSets((EventSets) this);
    }

    /**
     * Method called to associate a Events object to this object
     * through the Events foreign key attribute using connection.
     *
     * @param l Events
     * @throws TorqueException
     */
    public void addEvents(Events l, Connection con) throws TorqueException
    {
        getEventss(con).add(l);
        l.setEventSets((EventSets) this);
    }

    /**
     * The criteria used to select the current contents of collEventss
     */
    private Criteria lastEventssCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getEventss(new Criteria())
     *
        ...
        throws TorqueException
    {
        if (collEventss == null)
        {
            collEventss = getEventss(new Criteria(10));
        }
        return collEventss;
    }
     ...
     * Otherwise if this EventSets has previously
     * been saved, it will retrieve related Eventss from storage.
     * If this EventSets is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getEventss(Criteria criteria) throws TorqueException
    {
        if (collEventss == null)
        {
            if (isNew())
            ...
            {
                criteria.add(EventsPeer.EVENT_SET_ID, getId() );
                collEventss = EventsPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                criteria.add(EventsPeer.EVENT_SET_ID, getId());
                if (!lastEventssCriteria.equals(criteria))
                {
                    collEventss = EventsPeer.doSelect(criteria);
                }
            }
        }
        lastEventssCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getEventss(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getEventss(Connection con) throws TorqueException
    {
        if (collEventss == null)
        {
            collEventss = getEventss(new Criteria(10), con);
        }
        return collEventss;
    }
     ...
     * that is taken as input
     */
    public List getEventss(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collEventss == null)
        {
            ...
            {
                 criteria.add(EventsPeer.EVENT_SET_ID, getId());
                 collEventss = EventsPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this EventSets is new, it will return
     * an empty collection; or if this EventSets has previously
     * been saved, it will retrieve related Eventss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EventSets.
     */
    protected List getEventssJoinEventSets(Criteria criteria)
        throws TorqueException
    {
        if (collEventss == null)
        {
            ...
            {
                criteria.add(EventsPeer.EVENT_SET_ID, getId());
                collEventss = EventsPeer.doSelectJoinEventSets(criteria);
            }
        }
        else
        {
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.EVENT_SET_ID, getId() );
    ...
    {
        if (name.equals(EventSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(EventSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(EventSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(EventSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(EventSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(EventSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(EventSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(EventSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(EventSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (EventSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (EventSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (EventSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (EventSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (EventSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (EventSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (EventSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (EventSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (EventSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(EventSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    EventSetsPeer.doInsert((EventSets) this, con);
                    setNew(false);
                }
                else
                {
                    EventSetsPeer.doUpdate((EventSets) this, con);
                }
            }
            ...
            if (collEventss != null)
            {
                for (int i = 0; i < collEventss.size(); i++)
                {
                    ((Events) collEventss.get(i)).save(con);
                }
            }
     ...
     */
    public EventSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public EventSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public EventSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new EventSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public EventSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new EventSets(), deepcopy, con);
    }
     ...
     */
    protected EventSets copyInto(EventSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected EventSets copyInto(EventSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected EventSets copyInto(EventSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
        ...
        List vEventss = getEventss();
        if (vEventss != null)
        {
            for (int i = 0; i < vEventss.size(); i++)
            {
                Events obj = (Events) vEventss.get(i);
                copyObj.addEvents(obj.copy());
            }
        }
        else
        {
            copyObj.collEventss = null;
        }
     ...
     * @param con the database connection to read associated objects.
     */
    protected EventSets copyInto(EventSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
        ...
        List vEventss = getEventss(con);
        if (vEventss != null)
        {
            for (int i = 0; i < vEventss.size(); i++)
            {
                Events obj = (Events) vEventss.get(i);
                copyObj.addEvents(obj.copy(con), con);
            }
        }
        else
        {
    ...
    {
        return EventSetsPeer.getTableMap();
    }
