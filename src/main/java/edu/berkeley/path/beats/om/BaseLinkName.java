 ...
 * extended all references should be to LinkName
 */
public abstract class BaseLinkName extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final LinkNamePeer peer =
        new LinkNamePeer();
     ...
     * overridden in <code>LinkName</code>.
     */
    ...
    {
        if (name.equals(LinkNamePeer.ID))
        {
            return getId();
        }
        if (name.equals(LinkNamePeer.NETWORK_ID))
        {
            return getNetworkId();
        }
        if (name.equals(LinkNamePeer.NAME))
        {
            return getName();
        }
        if (name.equals(LinkNamePeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(LinkNamePeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(LinkNamePeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(LinkNamePeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(LinkNamePeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (LinkNamePeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (LinkNamePeer.NETWORK_ID.equals(name))
        {
            return setByName("NetworkId", value);
        }
      if (LinkNamePeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (LinkNamePeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (LinkNamePeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (LinkNamePeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (LinkNamePeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (LinkNamePeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(LinkNamePeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    LinkNamePeer.doInsert((LinkName) this, con);
                    setNew(false);
                }
                else
                {
                    LinkNamePeer.doUpdate((LinkName) this, con);
                }
            }
     ...
     */
    public LinkName copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public LinkName copy(Connection con) throws TorqueException
    {
     ...
     */
    public LinkName copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new LinkName(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public LinkName copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new LinkName(), deepcopy, con);
    }
     ...
     */
    protected LinkName copyInto(LinkName copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected LinkName copyInto(LinkName copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected LinkName copyInto(LinkName copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected LinkName copyInto(LinkName copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setNetworkId(networkId);
        copyObj.setName(name);
    ...
    {
        return LinkNamePeer.getTableMap();
    }
