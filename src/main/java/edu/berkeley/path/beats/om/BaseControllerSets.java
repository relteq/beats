 ...
 * extended all references should be to ControllerSets
 */
public abstract class BaseControllerSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final ControllerSetsPeer peer =
        new ControllerSetsPeer();
    ...
    public void addControllers(Controllers l) throws TorqueException
    {
        ...
        l.setControllerSets((ControllerSets) this);
    }
     ...
     * Otherwise if this ControllerSets has previously
     * been saved, it will retrieve related Controllerss from storage.
     * If this ControllerSets is new, it will return
    ...
    public List getControllerss(Criteria criteria) throws TorqueException
    {
        if (collControllerss == null)
        {
            ...
            {
                criteria.add(ControllersPeer.CONTROLLER_SET_ID, getId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this ControllerSets is new, it will return
     * an empty collection; or if this ControllerSets has previously
     * been saved, it will retrieve related Controllerss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ControllerSets.
     */
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.CONTROLLER_SET_ID, getId() );
    ...
    {
        if (name.equals(ControllerSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(ControllerSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(ControllerSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(ControllerSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(ControllerSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(ControllerSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(ControllerSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(ControllerSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(ControllerSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (ControllerSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (ControllerSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (ControllerSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (ControllerSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (ControllerSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (ControllerSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (ControllerSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (ControllerSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (ControllerSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(ControllerSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    ControllerSetsPeer.doInsert((ControllerSets) this, con);
                    setNew(false);
                }
                else
                {
                    ControllerSetsPeer.doUpdate((ControllerSets) this, con);
                }
            }
     ...
     */
    public ControllerSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public ControllerSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public ControllerSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new ControllerSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public ControllerSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new ControllerSets(), deepcopy, con);
    }
     ...
     */
    protected ControllerSets copyInto(ControllerSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected ControllerSets copyInto(ControllerSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected ControllerSets copyInto(ControllerSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected ControllerSets copyInto(ControllerSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
     ...
     */
    public ControllerSetsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return ControllerSetsPeer.getTableMap();
    }
