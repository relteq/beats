...
/**
  ...
  *
  */
public class ProjectsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.ProjectsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("projects");
        TableMap tMap = dbMap.getTable("projects");
        tMap.setJavaName("Projects");
        tMap.setOMClass( com.relteq.sirius.om.Projects.class );
        tMap.setPeerClass( com.relteq.sirius.om.ProjectsPeer.class );
