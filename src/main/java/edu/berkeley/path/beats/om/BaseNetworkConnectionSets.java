 ...
 * extended all references should be to NetworkConnectionSets
 */
public abstract class BaseNetworkConnectionSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final NetworkConnectionSetsPeer peer =
        new NetworkConnectionSetsPeer();
    ...
    public void setId(Long v) throws TorqueException
    {
        ...
        if (collNetworkConnectionss != null)
        {
            for (int i = 0; i < collNetworkConnectionss.size(); i++)
            {
                ((NetworkConnections) collNetworkConnectionss.get(i))
                        .setNetworkConnectionSetId(v);
            }
        }
    ...
    /**
     * Collection to store aggregation of collNetworkConnectionss
     */
    protected List collNetworkConnectionss;

    /**
     * Temporary storage of collNetworkConnectionss to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initNetworkConnectionss()
    {
        if (collNetworkConnectionss == null)
        {
            collNetworkConnectionss = new ArrayList();
        }
    }
     ...
     * @throws TorqueException
     */
    public void addNetworkConnections(NetworkConnections l) throws TorqueException
    {
        getNetworkConnectionss().add(l);
        l.setNetworkConnectionSets((NetworkConnectionSets) this);
    }
     ...
     * @throws TorqueException
     */
    public void addNetworkConnections(NetworkConnections l, Connection con) throws TorqueException
    {
        getNetworkConnectionss(con).add(l);
        l.setNetworkConnectionSets((NetworkConnectionSets) this);
    }

    /**
     * The criteria used to select the current contents of collNetworkConnectionss
     */
    private Criteria lastNetworkConnectionssCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getNetworkConnectionss(new Criteria())
     *
     * @return the collection of associated objects
     * @throws TorqueException
     */
    public List getNetworkConnectionss()
        throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            collNetworkConnectionss = getNetworkConnectionss(new Criteria(10));
        }
        return collNetworkConnectionss;
    }

    /**
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this NetworkConnectionSets has previously
     * been saved, it will retrieve related NetworkConnectionss from storage.
     * If this NetworkConnectionSets is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getNetworkConnectionss(Criteria criteria) throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            if (isNew())
            ...
            {
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId() );
                collNetworkConnectionss = NetworkConnectionsPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                if (!lastNetworkConnectionssCriteria.equals(criteria))
                {
                    collNetworkConnectionss = NetworkConnectionsPeer.doSelect(criteria);
                }
            }
        }
        lastNetworkConnectionssCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getNetworkConnectionss(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getNetworkConnectionss(Connection con) throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            collNetworkConnectionss = getNetworkConnectionss(new Criteria(10), con);
        }
        return collNetworkConnectionss;
    }
     ...
     * that is taken as input
     */
    public List getNetworkConnectionss(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            ...
            {
                 criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                 collNetworkConnectionss = NetworkConnectionsPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this NetworkConnectionSets is new, it will return
     * an empty collection; or if this NetworkConnectionSets has previously
     * been saved, it will retrieve related NetworkConnectionss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in NetworkConnectionSets.
     */
    protected List getNetworkConnectionssJoinNetworkConnectionSets(Criteria criteria)
        throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            ...
            {
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                collNetworkConnectionss = NetworkConnectionsPeer.doSelectJoinNetworkConnectionSets(criteria);
            }
        }
        else
        {
     ...
     * actually need in NetworkConnectionSets.
     */
    protected List getNetworkConnectionssJoinLinkFamiliesRelatedByFromLinkId(Criteria criteria)
        throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            ...
            {
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                collNetworkConnectionss = NetworkConnectionsPeer.doSelectJoinLinkFamiliesRelatedByFromLinkId(criteria);
            }
        }
        else
        {
     ...
     * actually need in NetworkConnectionSets.
     */
    protected List getNetworkConnectionssJoinNetworksRelatedByFromNetworkId(Criteria criteria)
        throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            ...
            {
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                collNetworkConnectionss = NetworkConnectionsPeer.doSelectJoinNetworksRelatedByFromNetworkId(criteria);
            }
        }
        else
        {
     ...
     * actually need in NetworkConnectionSets.
     */
    protected List getNetworkConnectionssJoinLinkFamiliesRelatedByToLinkId(Criteria criteria)
        throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            ...
            {
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                collNetworkConnectionss = NetworkConnectionsPeer.doSelectJoinLinkFamiliesRelatedByToLinkId(criteria);
            }
        }
        else
        {
     ...
     * actually need in NetworkConnectionSets.
     */
    protected List getNetworkConnectionssJoinNetworksRelatedByToNetworkId(Criteria criteria)
        throws TorqueException
    {
        if (collNetworkConnectionss == null)
        {
            ...
            {
                criteria.add(NetworkConnectionsPeer.NETWORK_CONNECTION_SET_ID, getId());
                collNetworkConnectionss = NetworkConnectionsPeer.doSelectJoinNetworksRelatedByToNetworkId(criteria);
            }
        }
        else
        {
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.NETWORK_CONNECTION_SET_ID, getId() );
    ...
    {
        if (name.equals(NetworkConnectionSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(NetworkConnectionSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(NetworkConnectionSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(NetworkConnectionSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(NetworkConnectionSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(NetworkConnectionSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(NetworkConnectionSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(NetworkConnectionSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(NetworkConnectionSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (NetworkConnectionSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (NetworkConnectionSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (NetworkConnectionSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (NetworkConnectionSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (NetworkConnectionSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (NetworkConnectionSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (NetworkConnectionSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (NetworkConnectionSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (NetworkConnectionSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(NetworkConnectionSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    NetworkConnectionSetsPeer.doInsert((NetworkConnectionSets) this, con);
                    setNew(false);
                }
                else
                {
                    NetworkConnectionSetsPeer.doUpdate((NetworkConnectionSets) this, con);
                }
            }
            ...
            if (collNetworkConnectionss != null)
            {
                for (int i = 0; i < collNetworkConnectionss.size(); i++)
                {
                    ((NetworkConnections) collNetworkConnectionss.get(i)).save(con);
                }
            }
     ...
     */
    public NetworkConnectionSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public NetworkConnectionSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public NetworkConnectionSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new NetworkConnectionSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public NetworkConnectionSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new NetworkConnectionSets(), deepcopy, con);
    }
     ...
     */
    protected NetworkConnectionSets copyInto(NetworkConnectionSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected NetworkConnectionSets copyInto(NetworkConnectionSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected NetworkConnectionSets copyInto(NetworkConnectionSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
        ...
        List vNetworkConnectionss = getNetworkConnectionss();
        if (vNetworkConnectionss != null)
        {
            for (int i = 0; i < vNetworkConnectionss.size(); i++)
            {
                NetworkConnections obj = (NetworkConnections) vNetworkConnectionss.get(i);
                copyObj.addNetworkConnections(obj.copy());
            }
        }
        else
        {
            copyObj.collNetworkConnectionss = null;
        }
     ...
     * @param con the database connection to read associated objects.
     */
    protected NetworkConnectionSets copyInto(NetworkConnectionSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
        ...
        List vNetworkConnectionss = getNetworkConnectionss(con);
        if (vNetworkConnectionss != null)
        {
            for (int i = 0; i < vNetworkConnectionss.size(); i++)
            {
                NetworkConnections obj = (NetworkConnections) vNetworkConnectionss.get(i);
                copyObj.addNetworkConnections(obj.copy(con), con);
            }
        }
        else
        {
     ...
     */
    public NetworkConnectionSetsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return NetworkConnectionSetsPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("NetworkConnectionSets:\n");
        str.append("Id = ")
           .append(getId())
           .append("\n");
