...
/**
  ...
  *
  */
public class LinkSpeedLimitMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.LinkSpeedLimitMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("link_speed_limit");
        TableMap tMap = dbMap.getTable("link_speed_limit");
        tMap.setJavaName("LinkSpeedLimit");
        tMap.setOMClass( com.relteq.sirius.om.LinkSpeedLimit.class );
        tMap.setPeerClass( com.relteq.sirius.om.LinkSpeedLimitPeer.class );
  ...
  // ------------- Column: network_id --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: speed_limit --------------------
        cMap = new ColumnMap( "speed_limit", tMap);
        cMap.setType( new BigDecimal((double) 0) );
        cMap.setTorqueType( "DECIMAL" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "SpeedLimit" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("In meters per second.");
        cMap.setInheritance("false");
        cMap.setSize( 31 );
        cMap.setScale( 16 );
        cMap.setPosition(3);
