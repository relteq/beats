...
/**
  ...
  *
  */
public class WeavingFactorSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.WeavingFactorSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("weaving_factor_sets");
        TableMap tMap = dbMap.getTable("weaving_factor_sets");
        tMap.setJavaName("WeavingFactorSets");
        tMap.setOMClass( com.relteq.sirius.om.WeavingFactorSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.WeavingFactorSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("weaving_factor_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("weaving_factor_sets");
        }
