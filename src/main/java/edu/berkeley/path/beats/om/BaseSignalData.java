 ...
 * extended all references should be to SignalData
 */
public abstract class BaseSignalData extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final SignalDataPeer peer =
        new SignalDataPeer();
    ...
    /** The value for the beginGreen field */
    private Date beginGreen;
    ...
    /**
     * Set the value of BeginGreen
     *
     * @param v new value
     */
    public void setBeginGreen(Date v) 
    {

        if (!ObjectUtils.equals(this.beginGreen, v))
        {
            this.beginGreen = v;
            setModified(true);
        }
    ...
    public Object getByName(String name)
    {
        ...
        if (name.equals("BeginGreen"))
        {
            return getBeginGreen();
        }
    ...
    {
        if (name.equals(SignalDataPeer.NETWORK_ID))
        {
            return getNetworkId();
        }
        if (name.equals(SignalDataPeer.SIGNAL_ID))
        {
            return getSignalId();
        }
        if (name.equals(SignalDataPeer.DATA_SOURCE_ID))
        {
            return getDataSourceId();
        }
        if (name.equals(SignalDataPeer.PHASE))
        {
            return getPhase();
        }
        if (name.equals(SignalDataPeer.TS))
        {
            return getTs();
        }
        if (name.equals(SignalDataPeer.AGGREGATION))
        {
            return getAggregation();
        }
        if (name.equals(SignalDataPeer.TYPE))
        {
            return getType();
        }
        if (name.equals(SignalDataPeer.BEGIN_GREEN))
        {
            return getBeginGreen();
        }
        if (name.equals(SignalDataPeer.DURATION))
        {
            return getDuration();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (SignalDataPeer.NETWORK_ID.equals(name))
        {
            return setByName("NetworkId", value);
        }
      if (SignalDataPeer.SIGNAL_ID.equals(name))
        {
            return setByName("SignalId", value);
        }
      if (SignalDataPeer.DATA_SOURCE_ID.equals(name))
        {
            return setByName("DataSourceId", value);
        }
      if (SignalDataPeer.PHASE.equals(name))
        {
            return setByName("Phase", value);
        }
      if (SignalDataPeer.TS.equals(name))
        {
            return setByName("Ts", value);
        }
      if (SignalDataPeer.AGGREGATION.equals(name))
        {
            return setByName("Aggregation", value);
        }
      if (SignalDataPeer.TYPE.equals(name))
        {
            return setByName("Type", value);
        }
      if (SignalDataPeer.BEGIN_GREEN.equals(name))
        {
            return setByName("BeginGreen", value);
        }
      if (SignalDataPeer.DURATION.equals(name))
        {
    ...
    {
        save(SignalDataPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    SignalDataPeer.doInsert((SignalData) this, con);
                    setNew(false);
                }
                else
                {
                    SignalDataPeer.doUpdate((SignalData) this, con);
                }
            }
     ...
     */
    public SignalData copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public SignalData copy(Connection con) throws TorqueException
    {
     ...
     */
    public SignalData copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new SignalData(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public SignalData copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new SignalData(), deepcopy, con);
    }
     ...
     */
    protected SignalData copyInto(SignalData copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected SignalData copyInto(SignalData copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected SignalData copyInto(SignalData copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        copyObj.setBeginGreen(beginGreen);
     ...
     * @param con the database connection to read associated objects.
     */
    protected SignalData copyInto(SignalData copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setNetworkId(networkId);
        copyObj.setSignalId(signalId);
        copyObj.setDataSourceId(dataSourceId);
    ...
    {
        return SignalDataPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("Type = ")
           .append(getType())
           .append("\n");
        str.append("BeginGreen = ")
           .append(getBeginGreen())
           .append("\n");
        str.append("Duration = ")
           .append(getDuration())
           .append("\n");
