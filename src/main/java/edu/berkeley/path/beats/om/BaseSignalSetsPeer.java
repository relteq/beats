 ...
 *
 */
public abstract class BaseSignalSetsPeer
    extends com.relteq.sirius.db.BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SignalSetsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SignalSetsMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "signal_sets";

        ID = "signal_sets.id";
        PROJECT_ID = "signal_sets.project_id";
        NAME = "signal_sets.name";
        DESCRIPTION = "signal_sets.description";
        CREATED = "signal_sets.created";
        MODIFIED = "signal_sets.modified";
        CREATED_BY = "signal_sets.created_by";
        MODIFIED_BY = "signal_sets.modified_by";
        MODSTAMP = "signal_sets.modstamp";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SignalSetsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SignalSetsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.relteq.sirius.om.SignalSets";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SignalSets row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SignalSets obj = (SignalSets) cls.newInstance();
            SignalSetsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(SignalSetsPeer.row2Object(row, 1,
                SignalSetsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(SignalSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SignalSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SignalSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SignalSets obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SignalSets) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SignalSets obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SignalSets) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SignalSets obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SignalSets) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SignalSets obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( SignalSets obj )
    {
    ...
    public static Criteria buildSelectCriteria( SignalSets obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static SignalSets retrieveByPK(Long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SignalSets retrieveByPK(Long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SignalSets retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SignalSets retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SignalSets retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
    ...
    /**
     * selects a collection of SignalSets objects pre-filled with their
     * Projects objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SignalSetsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(SignalSetsPeer.PROJECT_ID,
            ProjectsPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = SignalSetsPeer.getOMClass();
            SignalSets obj1 = (SignalSets) SignalSetsPeer
            ...
            {
                SignalSets temp_obj1 = (SignalSets) results.get(j);
                Projects temp_obj2 = (Projects) temp_obj1.getProjects();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addSignalSets(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initSignalSetss();
                obj2.addSignalSets(obj1);
            }
            results.add(obj1);
        }
        return results;
