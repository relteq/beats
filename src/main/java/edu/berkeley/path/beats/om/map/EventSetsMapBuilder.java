...
/**
  ...
  *
  */
public class EventSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.EventSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("event_sets");
        TableMap tMap = dbMap.getTable("event_sets");
        tMap.setJavaName("EventSets");
        tMap.setOMClass( com.relteq.sirius.om.EventSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.EventSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("event_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("event_sets");
        }
