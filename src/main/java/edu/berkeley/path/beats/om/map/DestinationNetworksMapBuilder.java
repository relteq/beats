...
/**
  ...
  *
  */
public class DestinationNetworksMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.DestinationNetworksMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("destination_networks");
        TableMap tMap = dbMap.getTable("destination_networks");
        tMap.setJavaName("DestinationNetworks");
        tMap.setOMClass( com.relteq.sirius.om.DestinationNetworks.class );
        tMap.setPeerClass( com.relteq.sirius.om.DestinationNetworksPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("destination_networks_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("destination_networks");
        }
