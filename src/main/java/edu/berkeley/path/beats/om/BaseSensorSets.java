 ...
 * extended all references should be to SensorSets
 */
public abstract class BaseSensorSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final SensorSetsPeer peer =
        new SensorSetsPeer();
    ...
    {
        getSensorss().add(l);
        l.setSensorSets((SensorSets) this);
    }
     ...
     * Otherwise if this SensorSets has previously
     * been saved, it will retrieve related Sensorss from storage.
     * If this SensorSets is new, it will return
    ...
    public List getSensorss(Criteria criteria) throws TorqueException
    {
        if (collSensorss == null)
        {
            ...
            {
                criteria.add(SensorsPeer.SENSOR_SET_ID, getId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this SensorSets is new, it will return
     * an empty collection; or if this SensorSets has previously
     * been saved, it will retrieve related Sensorss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SensorSets.
     */
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.SENSOR_SET_ID, getId() );
    ...
    {
        if (name.equals(SensorSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(SensorSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(SensorSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(SensorSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(SensorSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(SensorSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(SensorSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(SensorSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(SensorSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (SensorSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (SensorSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (SensorSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (SensorSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (SensorSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (SensorSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (SensorSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (SensorSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (SensorSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(SensorSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    SensorSetsPeer.doInsert((SensorSets) this, con);
                    setNew(false);
                }
                else
                {
                    SensorSetsPeer.doUpdate((SensorSets) this, con);
                }
            }
     ...
     */
    public SensorSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public SensorSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public SensorSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new SensorSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public SensorSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new SensorSets(), deepcopy, con);
    }
     ...
     */
    protected SensorSets copyInto(SensorSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected SensorSets copyInto(SensorSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected SensorSets copyInto(SensorSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected SensorSets copyInto(SensorSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
    ...
    {
        return SensorSetsPeer.getTableMap();
    }
