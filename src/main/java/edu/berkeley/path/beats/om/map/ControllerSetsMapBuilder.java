...
/**
  ...
  *
  */
public class ControllerSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.ControllerSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("controller_sets");
        TableMap tMap = dbMap.getTable("controller_sets");
        tMap.setJavaName("ControllerSets");
        tMap.setOMClass( com.relteq.sirius.om.ControllerSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.ControllerSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("controller_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("controller_sets");
        }
