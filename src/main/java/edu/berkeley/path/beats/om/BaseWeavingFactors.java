 ...
 * extended all references should be to WeavingFactors
 */
public abstract class BaseWeavingFactors extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final WeavingFactorsPeer peer =
        new WeavingFactorsPeer();
     ...
     * @param v new value
     */
    public void setFactor(BigDecimal v) 
    {

        if (!ObjectUtils.equals(this.factor, v))
        {
            this.factor = v;
            setModified(true);
        }
    ...
    {
        if (name.equals(WeavingFactorsPeer.WEAVING_FACTOR_SET_ID))
        {
            return getWeavingFactorSetId();
        }
        if (name.equals(WeavingFactorsPeer.IN_LINK_ID))
        {
            return getInLinkId();
        }
        if (name.equals(WeavingFactorsPeer.OUT_LINK_ID))
        {
            return getOutLinkId();
        }
        if (name.equals(WeavingFactorsPeer.VEHICLE_TYPE_ID))
        {
            return getVehicleTypeId();
        }
        if (name.equals(WeavingFactorsPeer.FACTOR))
        {
            return getFactor();
        }
        if (name.equals(WeavingFactorsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(WeavingFactorsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(WeavingFactorsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(WeavingFactorsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(WeavingFactorsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (WeavingFactorsPeer.WEAVING_FACTOR_SET_ID.equals(name))
        {
            return setByName("WeavingFactorSetId", value);
        }
      if (WeavingFactorsPeer.IN_LINK_ID.equals(name))
        {
            return setByName("InLinkId", value);
        }
      if (WeavingFactorsPeer.OUT_LINK_ID.equals(name))
        {
            return setByName("OutLinkId", value);
        }
      if (WeavingFactorsPeer.VEHICLE_TYPE_ID.equals(name))
        {
            return setByName("VehicleTypeId", value);
        }
      if (WeavingFactorsPeer.FACTOR.equals(name))
        {
            return setByName("Factor", value);
        }
      if (WeavingFactorsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (WeavingFactorsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (WeavingFactorsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (WeavingFactorsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (WeavingFactorsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(WeavingFactorsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    WeavingFactorsPeer.doInsert((WeavingFactors) this, con);
                    setNew(false);
                }
                else
                {
                    WeavingFactorsPeer.doUpdate((WeavingFactors) this, con);
                }
            }
    ...
    public void setPrimaryKey(ObjectKey key) throws TorqueException
    {
        ...
        setWeavingFactorSetId(new Long(((NumberKey)keys[0]).longValue()));
     ...
     */
    public void setPrimaryKey( Long weavingFactorSetId, Long inLinkId, Long outLinkId, Long vehicleTypeId)
        throws TorqueException
    {
        setWeavingFactorSetId(weavingFactorSetId);
    ...
    {
        pks[0] = SimpleKey.keyFor(getWeavingFactorSetId());
     ...
     */
    public WeavingFactors copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public WeavingFactors copy(Connection con) throws TorqueException
    {
     ...
     */
    public WeavingFactors copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new WeavingFactors(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public WeavingFactors copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new WeavingFactors(), deepcopy, con);
    }
     ...
     */
    protected WeavingFactors copyInto(WeavingFactors copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected WeavingFactors copyInto(WeavingFactors copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected WeavingFactors copyInto(WeavingFactors copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        copyObj.setWeavingFactorSetId((Long)null);
     ...
     * @param con the database connection to read associated objects.
     */
    protected WeavingFactors copyInto(WeavingFactors copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setWeavingFactorSetId(weavingFactorSetId);
        copyObj.setInLinkId(inLinkId);
        copyObj.setOutLinkId(outLinkId);
     ...
     */
    public WeavingFactorsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return WeavingFactorsPeer.getTableMap();
    }
