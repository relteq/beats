 ...
 *
 */
public abstract class BaseWeavingFactorsPeer
    extends com.relteq.sirius.db.BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(WeavingFactorsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(WeavingFactorsMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "weaving_factors";

        WEAVING_FACTOR_SET_ID = "weaving_factors.weaving_factor_set_id";
        IN_LINK_ID = "weaving_factors.in_link_id";
        OUT_LINK_ID = "weaving_factors.out_link_id";
        VEHICLE_TYPE_ID = "weaving_factors.vehicle_type_id";
        FACTOR = "weaving_factors.factor";
        CREATED = "weaving_factors.created";
        MODIFIED = "weaving_factors.modified";
        CREATED_BY = "weaving_factors.created_by";
        MODIFIED_BY = "weaving_factors.modified_by";
        MODSTAMP = "weaving_factors.modstamp";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(WeavingFactorsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(WeavingFactorsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.relteq.sirius.om.WeavingFactors";
            ...
            throws TorqueException
    {
        ...
        criteria.addSelectColumn(FACTOR);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static WeavingFactors row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            WeavingFactors obj = (WeavingFactors) cls.newInstance();
            WeavingFactorsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            obj.setWeavingFactorSetId(row.getValue(offset + 0).asLongObj());
            ...
            obj.setFactor(row.getValue(offset + 4).asBigDecimal());
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(WeavingFactorsPeer.row2Object(row, 1,
                WeavingFactorsPeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(WEAVING_FACTOR_SET_ID, criteria.remove(WEAVING_FACTOR_SET_ID));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(WeavingFactors obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(WeavingFactors obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(WeavingFactors obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(WeavingFactors obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(WeavingFactors) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(WeavingFactors obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(WeavingFactors) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(WeavingFactors obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(WeavingFactors) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(WeavingFactors obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        ...
        SimpleKey[] keys = (SimpleKey[])pk.getValue();
            criteria.add(WEAVING_FACTOR_SET_ID, keys[0]);
    ...
    public static Criteria buildCriteria( WeavingFactors obj )
    {
        ...
        criteria.add(FACTOR, obj.getFactor());
    ...
    public static Criteria buildSelectCriteria( WeavingFactors obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(WEAVING_FACTOR_SET_ID, obj.getWeavingFactorSetId());
            criteria.add(IN_LINK_ID, obj.getInLinkId());
     ...
     */
    public static WeavingFactors retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        WeavingFactors retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static WeavingFactors retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
            ...
            while (iter.hasNext())
            {
                ...
                SimpleKey[] keys = (SimpleKey[])pk.getValue();
                    Criteria.Criterion c0 = criteria.getNewCriterion(
                        WEAVING_FACTOR_SET_ID, keys[0], Criteria.EQUAL);
     ...
     *
     * @param weavingFactorSetId Long
     * @param inLinkId Long
     * @param outLinkId Long
     * @param vehicleTypeId Long
     */
    public static WeavingFactors retrieveByPK(
 Long weavingFactorSetId
, Long inLinkId
, Long outLinkId
, Long vehicleTypeId
        ) throws TorqueException
...
, Long vehicleTypeId
       ,Connection con) throws TorqueException
    {
        ...
        criteria.add(WEAVING_FACTOR_SET_ID, weavingFactorSetId);
    ...
    /**
     * selects a collection of WeavingFactors objects pre-filled with their
     * WeavingFactorSets objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in WeavingFactorsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        WeavingFactorsPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        WeavingFactorSetsPeer.addSelectColumns(criteria);

        criteria.addJoin(WeavingFactorsPeer.WEAVING_FACTOR_SET_ID,
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = WeavingFactorsPeer.getOMClass();
            WeavingFactors obj1 = (WeavingFactors) WeavingFactorsPeer
            ...
            {
                WeavingFactors temp_obj1 = (WeavingFactors) results.get(j);
                WeavingFactorSets temp_obj2 = (WeavingFactorSets) temp_obj1.getWeavingFactorSets();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addWeavingFactors(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initWeavingFactorss();
                obj2.addWeavingFactors(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(WeavingFactorsPeer.IN_LINK_ID,
            LinkFamiliesPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj2.addWeavingFactorsRelatedByInLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initWeavingFactorssRelatedByInLinkId();
                obj2.addWeavingFactorsRelatedByInLinkId(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(WeavingFactorsPeer.OUT_LINK_ID,
            LinkFamiliesPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj2.addWeavingFactorsRelatedByOutLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initWeavingFactorssRelatedByOutLinkId();
                obj2.addWeavingFactorsRelatedByOutLinkId(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(WeavingFactorsPeer.VEHICLE_TYPE_ID,
    ...
    /**
     * selects a collection of WeavingFactors objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
        ...
        throws TorqueException
    {
        ...
        LinkFamiliesPeer.addSelectColumns(criteria);
        criteria.addJoin(WeavingFactorsPeer.IN_LINK_ID, LinkFamiliesPeer.ID);
        int offset3 = offset2 + LinkFamiliesPeer.numColumns;

        LinkFamiliesPeer.addSelectColumns(criteria);
        criteria.addJoin(WeavingFactorsPeer.OUT_LINK_ID, LinkFamiliesPeer.ID);
        int offset4 = offset3 + LinkFamiliesPeer.numColumns;

        VehicleTypesPeer.addSelectColumns(criteria);
        criteria.addJoin(WeavingFactorsPeer.VEHICLE_TYPE_ID, VehicleTypesPeer.VEHICLE_TYPE_ID);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addWeavingFactorsRelatedByOutLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initWeavingFactorssRelatedByOutLinkId();
                obj3.addWeavingFactorsRelatedByOutLinkId(obj1);
            }
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj4.addWeavingFactors(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj4.initWeavingFactorss();
                obj4.addWeavingFactors(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        WeavingFactorSetsPeer.addSelectColumns(criteria);
        criteria.addJoin(WeavingFactorsPeer.WEAVING_FACTOR_SET_ID, WeavingFactorSetsPeer.ID);
        int offset3 = offset2 + WeavingFactorSetsPeer.numColumns;
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addWeavingFactors(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initWeavingFactorss();
                obj3.addWeavingFactors(obj1);
            }
            results.add(obj1);
        }
        return results;
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addWeavingFactorsRelatedByInLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initWeavingFactorssRelatedByInLinkId();
                obj3.addWeavingFactorsRelatedByInLinkId(obj1);
            }
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj4.addWeavingFactorsRelatedByOutLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj4.initWeavingFactorssRelatedByOutLinkId();
                obj4.addWeavingFactorsRelatedByOutLinkId(obj1);
            }
