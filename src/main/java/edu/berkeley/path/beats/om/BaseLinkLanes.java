 ...
 * extended all references should be to LinkLanes
 */
public abstract class BaseLinkLanes extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final LinkLanesPeer peer =
        new LinkLanesPeer();
    ...
    /** The value for the lanes field */
    private BigDecimal lanes;
     ...
     * @param v new value
     */
    public void setLanes(BigDecimal v) 
    {

        if (!ObjectUtils.equals(this.lanes, v))
        {
            this.lanes = v;
            setModified(true);
        }
     ...
     * link_lanes and links.
     * If for some reason this is impossible, this method should be
     * overridden in <code>LinkLanes</code>.
     */
    ...
    {
        if (name.equals(LinkLanesPeer.ID))
        {
            return getId();
        }
        if (name.equals(LinkLanesPeer.NETWORK_ID))
        {
            return getNetworkId();
        }
        if (name.equals(LinkLanesPeer.LANES))
        {
            return getLanes();
        }
        if (name.equals(LinkLanesPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(LinkLanesPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(LinkLanesPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(LinkLanesPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(LinkLanesPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (LinkLanesPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (LinkLanesPeer.NETWORK_ID.equals(name))
        {
            return setByName("NetworkId", value);
        }
      if (LinkLanesPeer.LANES.equals(name))
        {
            return setByName("Lanes", value);
        }
      if (LinkLanesPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (LinkLanesPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (LinkLanesPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (LinkLanesPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (LinkLanesPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(LinkLanesPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    LinkLanesPeer.doInsert((LinkLanes) this, con);
                    setNew(false);
                }
                else
                {
                    LinkLanesPeer.doUpdate((LinkLanes) this, con);
                }
            }
     ...
     */
    public LinkLanes copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public LinkLanes copy(Connection con) throws TorqueException
    {
     ...
     */
    public LinkLanes copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new LinkLanes(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public LinkLanes copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new LinkLanes(), deepcopy, con);
    }
     ...
     */
    protected LinkLanes copyInto(LinkLanes copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected LinkLanes copyInto(LinkLanes copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected LinkLanes copyInto(LinkLanes copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setNetworkId(networkId);
        copyObj.setLanes(lanes);
     ...
     * @param con the database connection to read associated objects.
     */
    protected LinkLanes copyInto(LinkLanes copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setNetworkId(networkId);
        copyObj.setLanes(lanes);
    ...
    {
        return LinkLanesPeer.getTableMap();
    }
