 ...
 *
 */
public abstract class BaseSplitRatiosPeer
    extends com.relteq.sirius.db.BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(SplitRatiosMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(SplitRatiosMapBuilder.CLASS_NAME);
    }

    /** the column name for the split_ratio_profile_id field */
    public static final String SPLIT_RATIO_PROFILE_ID;
    ...
    /** the column name for the ordinal field */
    ...
    static
    {
        ...
        TABLE_NAME = "split_ratios";

        SPLIT_RATIO_PROFILE_ID = "split_ratios.split_ratio_profile_id";
        IN_LINK_ID = "split_ratios.in_link_id";
        OUT_LINK_ID = "split_ratios.out_link_id";
        VEHICLE_TYPE_ID = "split_ratios.vehicle_type_id";
        ORDINAL = "split_ratios.ordinal";
        SPLIT_RATIO = "split_ratios.split_ratio";
        CREATED = "split_ratios.created";
        MODIFIED = "split_ratios.modified";
        CREATED_BY = "split_ratios.created_by";
        MODIFIED_BY = "split_ratios.modified_by";
        MODSTAMP = "split_ratios.modstamp";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(SplitRatiosMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(SplitRatiosMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.relteq.sirius.om.SplitRatios";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static SplitRatios row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            SplitRatios obj = (SplitRatios) cls.newInstance();
            SplitRatiosPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        try
        {
            obj.setSplitRatioProfileId(row.getValue(offset + 0).asLongObj());
            ...
            obj.setOrdinal(row.getValue(offset + 4).asIntegerObj());
            obj.setSplitRatio(row.getValue(offset + 5).asBigDecimal());
            obj.setCreated(row.getValue(offset + 6).asUtilDate());
            obj.setModified(row.getValue(offset + 7).asUtilDate());
            obj.setCreatedBy(row.getValue(offset + 8).asString());
            obj.setModifiedBy(row.getValue(offset + 9).asString());
            obj.setModstamp(row.getValue(offset + 10).asUtilDate());
        }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(SplitRatiosPeer.row2Object(row, 1,
                SplitRatiosPeer.getOMClass()));
        }
        return results;
    }
        ...
        throws TorqueException
    {
        ...
        correctBooleans(criteria);
         ...
         selectCriteria.put(SPLIT_RATIO_PROFILE_ID, criteria.remove(SPLIT_RATIO_PROFILE_ID));
         ...
         selectCriteria.put(ORDINAL, criteria.remove(ORDINAL));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(SplitRatios obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SplitRatios obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SplitRatios obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SplitRatios obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(SplitRatios) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(SplitRatios obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(SplitRatios) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(SplitRatios obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(SplitRatios) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(SplitRatios obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( ObjectKey pk )
    {
        ...
        SimpleKey[] keys = (SimpleKey[])pk.getValue();
            criteria.add(SPLIT_RATIO_PROFILE_ID, keys[0]);
            criteria.add(IN_LINK_ID, keys[1]);
            criteria.add(OUT_LINK_ID, keys[2]);
            criteria.add(VEHICLE_TYPE_ID, keys[3]);
            criteria.add(ORDINAL, keys[4]);
        return criteria;
     }

    /** Build a Criteria object from the data object for this peer */
    public static Criteria buildCriteria( SplitRatios obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        criteria.add(SPLIT_RATIO_PROFILE_ID, obj.getSplitRatioProfileId());
        ...
        criteria.add(ORDINAL, obj.getOrdinal());
    ...
    public static Criteria buildSelectCriteria( SplitRatios obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
            criteria.add(SPLIT_RATIO_PROFILE_ID, obj.getSplitRatioProfileId());
            criteria.add(IN_LINK_ID, obj.getInLinkId());
     ...
     */
    public static SplitRatios retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        SplitRatios retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static SplitRatios retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
            ...
            while (iter.hasNext())
            {
                ...
                SimpleKey[] keys = (SimpleKey[])pk.getValue();
                    Criteria.Criterion c0 = criteria.getNewCriterion(
                        SPLIT_RATIO_PROFILE_ID, keys[0], Criteria.EQUAL);
     ...
     */
    public static SplitRatios retrieveByPK(
 Long splitRatioProfileId
, Long inLinkId
, Long outLinkId
, Long vehicleTypeId
, Integer ordinal
...
, Integer ordinal
    ...
    /**
     * selects a collection of SplitRatios objects pre-filled with their
     * SplitRatioProfiles objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SplitRatiosPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinSplitRatioProfiles(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinSplitRatioProfiles(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinSplitRatioProfiles(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);

        SplitRatiosPeer.addSelectColumns(criteria);
        int offset = numColumns + 1;
        SplitRatioProfilesPeer.addSelectColumns(criteria);

        criteria.addJoin(SplitRatiosPeer.SPLIT_RATIO_PROFILE_ID,
            SplitRatioProfilesPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = SplitRatiosPeer.getOMClass();
            SplitRatios obj1 = (SplitRatios) SplitRatiosPeer
                .row2Object(row, 1, omClass);
             omClass = SplitRatioProfilesPeer.getOMClass();
            SplitRatioProfiles obj2 = (SplitRatioProfiles) SplitRatioProfilesPeer
                .row2Object(row, offset, omClass);

            boolean newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                SplitRatios temp_obj1 = (SplitRatios) results.get(j);
                SplitRatioProfiles temp_obj2 = (SplitRatioProfiles) temp_obj1.getSplitRatioProfiles();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addSplitRatios(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initSplitRatioss();
                obj2.addSplitRatios(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(SplitRatiosPeer.IN_LINK_ID,
            LinkFamiliesPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj2.addSplitRatiosRelatedByInLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initSplitRatiossRelatedByInLinkId();
                obj2.addSplitRatiosRelatedByInLinkId(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(SplitRatiosPeer.OUT_LINK_ID,
            LinkFamiliesPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj2.addSplitRatiosRelatedByOutLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj2.initSplitRatiossRelatedByOutLinkId();
                obj2.addSplitRatiosRelatedByOutLinkId(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(SplitRatiosPeer.VEHICLE_TYPE_ID,
    ...
    /**
     * selects a collection of SplitRatios objects pre-filled with
     * all related objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinAllExceptSplitRatioProfiles(Criteria criteria)
        throws TorqueException
    {
        return doSelectJoinAllExceptSplitRatioProfiles(criteria, null);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    protected static List doSelectJoinAllExceptSplitRatioProfiles(Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
        ...
        LinkFamiliesPeer.addSelectColumns(criteria);
        criteria.addJoin(SplitRatiosPeer.IN_LINK_ID, LinkFamiliesPeer.ID);
        int offset3 = offset2 + LinkFamiliesPeer.numColumns;

        LinkFamiliesPeer.addSelectColumns(criteria);
        criteria.addJoin(SplitRatiosPeer.OUT_LINK_ID, LinkFamiliesPeer.ID);
        int offset4 = offset3 + LinkFamiliesPeer.numColumns;

        VehicleTypesPeer.addSelectColumns(criteria);
        criteria.addJoin(SplitRatiosPeer.VEHICLE_TYPE_ID, VehicleTypesPeer.VEHICLE_TYPE_ID);
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addSplitRatiosRelatedByOutLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initSplitRatiossRelatedByOutLinkId();
                obj3.addSplitRatiosRelatedByOutLinkId(obj1);
            }
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj4.addSplitRatios(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj4.initSplitRatioss();
                obj4.addSplitRatios(obj1);
            }
            results.add(obj1);
        }
        return results;
        ...
        throws TorqueException
    {
        ...
        SplitRatioProfilesPeer.addSelectColumns(criteria);
        criteria.addJoin(SplitRatiosPeer.SPLIT_RATIO_PROFILE_ID, SplitRatioProfilesPeer.ID);
        int offset3 = offset2 + SplitRatioProfilesPeer.numColumns;
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addSplitRatios(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initSplitRatioss();
                obj3.addSplitRatios(obj1);
            }
            results.add(obj1);
        }
        return results;
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj3.addSplitRatiosRelatedByInLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj3.initSplitRatiossRelatedByInLinkId();
                obj3.addSplitRatiosRelatedByInLinkId(obj1);
            }
 ...
 newObject = true;
            for (int j = 0; j < results.size(); j++)
            {
                ...
                {
                    newObject = false;
                    temp_obj4.addSplitRatiosRelatedByOutLinkId(obj1);
                    break;
                }
            }
            if (newObject)
            {
                obj4.initSplitRatiossRelatedByOutLinkId();
                obj4.addSplitRatiosRelatedByOutLinkId(obj1);
            }
