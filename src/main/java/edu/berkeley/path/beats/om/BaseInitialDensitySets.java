 ...
 * extended all references should be to InitialDensitySets
 */
public abstract class BaseInitialDensitySets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final InitialDensitySetsPeer peer =
        new InitialDensitySetsPeer();
    ...
    public void addInitialDensities(InitialDensities l) throws TorqueException
    {
        ...
        l.setInitialDensitySets((InitialDensitySets) this);
    }
     ...
     * Otherwise if this InitialDensitySets has previously
     * been saved, it will retrieve related InitialDensitiess from storage.
     * If this InitialDensitySets is new, it will return
    ...
    public List getInitialDensitiess(Criteria criteria) throws TorqueException
    {
        if (collInitialDensitiess == null)
        {
            ...
            {
                criteria.add(InitialDensitiesPeer.INITIAL_DENSITY_SET_ID, getId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this InitialDensitySets is new, it will return
     * an empty collection; or if this InitialDensitySets has previously
     * been saved, it will retrieve related InitialDensitiess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in InitialDensitySets.
     */
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.INITIAL_DENSITY_SET_ID, getId() );
    ...
    {
        if (name.equals(InitialDensitySetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(InitialDensitySetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(InitialDensitySetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(InitialDensitySetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(InitialDensitySetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(InitialDensitySetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(InitialDensitySetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(InitialDensitySetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(InitialDensitySetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (InitialDensitySetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (InitialDensitySetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (InitialDensitySetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (InitialDensitySetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (InitialDensitySetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (InitialDensitySetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (InitialDensitySetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (InitialDensitySetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (InitialDensitySetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(InitialDensitySetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    InitialDensitySetsPeer.doInsert((InitialDensitySets) this, con);
                    setNew(false);
                }
                else
                {
                    InitialDensitySetsPeer.doUpdate((InitialDensitySets) this, con);
                }
            }
     ...
     */
    public InitialDensitySets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public InitialDensitySets copy(Connection con) throws TorqueException
    {
     ...
     */
    public InitialDensitySets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new InitialDensitySets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public InitialDensitySets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new InitialDensitySets(), deepcopy, con);
    }
     ...
     */
    protected InitialDensitySets copyInto(InitialDensitySets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected InitialDensitySets copyInto(InitialDensitySets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected InitialDensitySets copyInto(InitialDensitySets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected InitialDensitySets copyInto(InitialDensitySets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
     ...
     */
    public InitialDensitySetsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return InitialDensitySetsPeer.getTableMap();
    }
