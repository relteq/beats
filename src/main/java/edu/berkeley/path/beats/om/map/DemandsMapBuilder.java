...
/**
  ...
  *
  */
public class DemandsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.DemandsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("demands");
        TableMap tMap = dbMap.getTable("demands");
        tMap.setJavaName("Demands");
        tMap.setOMClass( com.relteq.sirius.om.Demands.class );
        tMap.setPeerClass( com.relteq.sirius.om.DemandsPeer.class );
        tMap.setPrimaryKeyMethod("none");

        ColumnMap cMap = null;


  // ------------- Column: demand_profile_id --------------------
        cMap = new ColumnMap( "demand_profile_id", tMap);
        cMap.setType( new Long(0) );
        cMap.setTorqueType( "BIGINT" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(true);
        cMap.setNotNull(false);
        cMap.setJavaName( "DemandProfileId" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("demand_profiles", "id");
        cMap.setPosition(1);
        tMap.addColumn(cMap);
  ...
  // ------------- Column: number --------------------
        ...
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("Order of the demand");
        cMap.setInheritance("false");
        cMap.setPosition(3);
        tMap.addColumn(cMap);
  // ------------- Column: demand --------------------
        cMap = new ColumnMap( "demand", tMap);
        cMap.setType( new BigDecimal((double) 0) );
        cMap.setTorqueType( "DECIMAL" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "Demand" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("Demand flow in vph.");
        cMap.setInheritance("false");
        cMap.setSize( 31 );
        cMap.setScale( 16 );
        cMap.setPosition(4);
