...
/**
  ...
  *
  */
public class DemandProfileSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.DemandProfileSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("demand_profile_sets");
        TableMap tMap = dbMap.getTable("demand_profile_sets");
        tMap.setJavaName("DemandProfileSets");
        tMap.setOMClass( com.relteq.sirius.om.DemandProfileSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.DemandProfileSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("demand_profile_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("demand_profile_sets");
        }
