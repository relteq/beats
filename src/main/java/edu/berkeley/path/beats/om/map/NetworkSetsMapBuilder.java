...
/**
  ...
  *
  */
public class NetworkSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.NetworkSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("network_sets");
        TableMap tMap = dbMap.getTable("network_sets");
        tMap.setJavaName("NetworkSets");
        tMap.setOMClass( com.relteq.sirius.om.NetworkSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.NetworkSetsPeer.class );
