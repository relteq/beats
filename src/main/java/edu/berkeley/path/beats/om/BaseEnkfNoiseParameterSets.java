 ...
 * extended all references should be to EnkfNoiseParameterSets
 */
public abstract class BaseEnkfNoiseParameterSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final EnkfNoiseParameterSetsPeer peer =
        new EnkfNoiseParameterSetsPeer();
    ...
    public void setId(Long v) throws TorqueException
    {
        ...
        // update associated EnkfNoiseParameters
        if (collEnkfNoiseParameterss != null)
        {
            for (int i = 0; i < collEnkfNoiseParameterss.size(); i++)
            {
                ((EnkfNoiseParameters) collEnkfNoiseParameterss.get(i))
                        .setEnkfNoiseParameterSetId(v);
            }
        }
    ...
    /**
     * Collection to store aggregation of collEnkfNoiseParameterss
     */
    protected List collEnkfNoiseParameterss;

    /**
     * Temporary storage of collEnkfNoiseParameterss to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initEnkfNoiseParameterss()
    {
        if (collEnkfNoiseParameterss == null)
        {
            collEnkfNoiseParameterss = new ArrayList();
        }
    }


    /**
     * Method called to associate a EnkfNoiseParameters object to this object
     * through the EnkfNoiseParameters foreign key attribute
     *
     * @param l EnkfNoiseParameters
     * @throws TorqueException
     */
    public void addEnkfNoiseParameters(EnkfNoiseParameters l) throws TorqueException
    {
        getEnkfNoiseParameterss().add(l);
        l.setEnkfNoiseParameterSets((EnkfNoiseParameterSets) this);
    }

    /**
     * Method called to associate a EnkfNoiseParameters object to this object
     * through the EnkfNoiseParameters foreign key attribute using connection.
     *
     * @param l EnkfNoiseParameters
     * @throws TorqueException
     */
    public void addEnkfNoiseParameters(EnkfNoiseParameters l, Connection con) throws TorqueException
    {
        getEnkfNoiseParameterss(con).add(l);
        l.setEnkfNoiseParameterSets((EnkfNoiseParameterSets) this);
    }

    /**
     * The criteria used to select the current contents of collEnkfNoiseParameterss
     */
    private Criteria lastEnkfNoiseParameterssCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getEnkfNoiseParameterss(new Criteria())
     *
     * @return the collection of associated objects
     * @throws TorqueException
     */
    public List getEnkfNoiseParameterss()
        throws TorqueException
    {
        if (collEnkfNoiseParameterss == null)
        {
            collEnkfNoiseParameterss = getEnkfNoiseParameterss(new Criteria(10));
        }
        return collEnkfNoiseParameterss;
    }

    /**
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this EnkfNoiseParameterSets has previously
     * been saved, it will retrieve related EnkfNoiseParameterss from storage.
     * If this EnkfNoiseParameterSets is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getEnkfNoiseParameterss(Criteria criteria) throws TorqueException
    {
        if (collEnkfNoiseParameterss == null)
        {
            if (isNew())
            ...
            {
                criteria.add(EnkfNoiseParametersPeer.ENKF_NOISE_PARAMETER_SET_ID, getId() );
                collEnkfNoiseParameterss = EnkfNoiseParametersPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                criteria.add(EnkfNoiseParametersPeer.ENKF_NOISE_PARAMETER_SET_ID, getId());
                if (!lastEnkfNoiseParameterssCriteria.equals(criteria))
                {
                    collEnkfNoiseParameterss = EnkfNoiseParametersPeer.doSelect(criteria);
                }
            }
        }
        lastEnkfNoiseParameterssCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getEnkfNoiseParameterss(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getEnkfNoiseParameterss(Connection con) throws TorqueException
    {
        if (collEnkfNoiseParameterss == null)
        {
            collEnkfNoiseParameterss = getEnkfNoiseParameterss(new Criteria(10), con);
        }
        return collEnkfNoiseParameterss;
    }
     ...
     * that is taken as input
     */
    public List getEnkfNoiseParameterss(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collEnkfNoiseParameterss == null)
        {
            ...
            {
                 criteria.add(EnkfNoiseParametersPeer.ENKF_NOISE_PARAMETER_SET_ID, getId());
                 collEnkfNoiseParameterss = EnkfNoiseParametersPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this EnkfNoiseParameterSets is new, it will return
     * an empty collection; or if this EnkfNoiseParameterSets has previously
     * been saved, it will retrieve related EnkfNoiseParameterss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EnkfNoiseParameterSets.
     */
    protected List getEnkfNoiseParameterssJoinEnkfNoiseParameterSets(Criteria criteria)
        throws TorqueException
    {
        if (collEnkfNoiseParameterss == null)
        {
            ...
            {
                criteria.add(EnkfNoiseParametersPeer.ENKF_NOISE_PARAMETER_SET_ID, getId());
                collEnkfNoiseParameterss = EnkfNoiseParametersPeer.doSelectJoinEnkfNoiseParameterSets(criteria);
            }
        }
        else
        {
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.ENKF_NOISE_PARAMETER_SET_ID, getId() );
    ...
    {
        if (name.equals(EnkfNoiseParameterSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(EnkfNoiseParameterSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (EnkfNoiseParameterSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (EnkfNoiseParameterSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (EnkfNoiseParameterSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (EnkfNoiseParameterSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (EnkfNoiseParameterSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (EnkfNoiseParameterSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (EnkfNoiseParameterSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (EnkfNoiseParameterSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (EnkfNoiseParameterSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(EnkfNoiseParameterSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    EnkfNoiseParameterSetsPeer.doInsert((EnkfNoiseParameterSets) this, con);
                    setNew(false);
                }
                else
                {
                    EnkfNoiseParameterSetsPeer.doUpdate((EnkfNoiseParameterSets) this, con);
                }
            }
            ...
            if (collEnkfNoiseParameterss != null)
            {
                for (int i = 0; i < collEnkfNoiseParameterss.size(); i++)
                {
                    ((EnkfNoiseParameters) collEnkfNoiseParameterss.get(i)).save(con);
                }
            }
     ...
     */
    public EnkfNoiseParameterSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public EnkfNoiseParameterSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public EnkfNoiseParameterSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new EnkfNoiseParameterSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public EnkfNoiseParameterSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new EnkfNoiseParameterSets(), deepcopy, con);
    }
     ...
     */
    protected EnkfNoiseParameterSets copyInto(EnkfNoiseParameterSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected EnkfNoiseParameterSets copyInto(EnkfNoiseParameterSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected EnkfNoiseParameterSets copyInto(EnkfNoiseParameterSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
        ...
        List vEnkfNoiseParameterss = getEnkfNoiseParameterss();
        if (vEnkfNoiseParameterss != null)
        {
            for (int i = 0; i < vEnkfNoiseParameterss.size(); i++)
            {
                EnkfNoiseParameters obj = (EnkfNoiseParameters) vEnkfNoiseParameterss.get(i);
                copyObj.addEnkfNoiseParameters(obj.copy());
            }
        }
        else
        {
            copyObj.collEnkfNoiseParameterss = null;
        }
     ...
     * @param con the database connection to read associated objects.
     */
    protected EnkfNoiseParameterSets copyInto(EnkfNoiseParameterSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
        ...
        List vEnkfNoiseParameterss = getEnkfNoiseParameterss(con);
        if (vEnkfNoiseParameterss != null)
        {
            for (int i = 0; i < vEnkfNoiseParameterss.size(); i++)
            {
                EnkfNoiseParameters obj = (EnkfNoiseParameters) vEnkfNoiseParameterss.get(i);
                copyObj.addEnkfNoiseParameters(obj.copy(con), con);
            }
        }
        else
        {
     ...
     */
    public EnkfNoiseParameterSetsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return EnkfNoiseParameterSetsPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("EnkfNoiseParameterSets:\n");
        str.append("Id = ")
           .append(getId())
           .append("\n");
