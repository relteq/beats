...
/**
  ...
  *
  */
public class SplitRatiosMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.SplitRatiosMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("split_ratios");
        TableMap tMap = dbMap.getTable("split_ratios");
        tMap.setJavaName("SplitRatios");
        tMap.setOMClass( com.relteq.sirius.om.SplitRatios.class );
        tMap.setPeerClass( com.relteq.sirius.om.SplitRatiosPeer.class );
        tMap.setPrimaryKeyMethod("none");

        ColumnMap cMap = null;


  // ------------- Column: split_ratio_profile_id --------------------
        cMap = new ColumnMap( "split_ratio_profile_id", tMap);
        cMap.setType( new Long(0) );
        cMap.setTorqueType( "BIGINT" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(true);
        cMap.setNotNull(false);
        cMap.setJavaName( "SplitRatioProfileId" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("split_ratio_profiles", "id");
        cMap.setPosition(1);
        tMap.addColumn(cMap);
  // ------------- Column: in_link_id --------------------
  ...
  // ------------- Column: vehicle_type_id --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: ordinal --------------------
        cMap = new ColumnMap( "ordinal", tMap);
        cMap.setType( new Integer(0) );
        cMap.setTorqueType( "INTEGER" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(true);
        cMap.setNotNull(false);
        cMap.setJavaName( "Ordinal" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("Order of the split ratio");
        cMap.setInheritance("false");
        cMap.setPosition(5);
        tMap.addColumn(cMap);
  // ------------- Column: split_ratio --------------------
