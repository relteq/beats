...
/**
  ...
  *
  */
public class LinkLanesMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.LinkLanesMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("link_lanes");
        TableMap tMap = dbMap.getTable("link_lanes");
        tMap.setJavaName("LinkLanes");
        tMap.setOMClass( com.relteq.sirius.om.LinkLanes.class );
        tMap.setPeerClass( com.relteq.sirius.om.LinkLanesPeer.class );
  ...
  // ------------- Column: network_id --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: lanes --------------------
        cMap = new ColumnMap( "lanes", tMap);
        cMap.setType( new BigDecimal((double) 0) );
        cMap.setTorqueType( "DECIMAL" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "Lanes" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("Number of lanes.");
        cMap.setInheritance("false");
        cMap.setSize( 31 );
        cMap.setScale( 16 );
        cMap.setPosition(3);
