 ...
 * extended all references should be to DefaultSimulationSettings
 */
public abstract class BaseDefaultSimulationSettings extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final DefaultSimulationSettingsPeer peer =
        new DefaultSimulationSettingsPeer();
    ...
    {
        if (name.equals(DefaultSimulationSettingsPeer.SCENARIO_ID))
        {
            return getScenarioId();
        }
        if (name.equals(DefaultSimulationSettingsPeer.SIMULATION_START_TIME))
        {
            return getSimulationStartTime();
        }
        if (name.equals(DefaultSimulationSettingsPeer.SIMULATION_DURATION))
        {
            return getSimulationDuration();
        }
        if (name.equals(DefaultSimulationSettingsPeer.SIMULATION_DT))
        {
            return getSimulationDt();
        }
        if (name.equals(DefaultSimulationSettingsPeer.OUTPUT_DT))
        {
            return getOutputDt();
        }
        if (name.equals(DefaultSimulationSettingsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(DefaultSimulationSettingsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(DefaultSimulationSettingsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(DefaultSimulationSettingsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(DefaultSimulationSettingsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (DefaultSimulationSettingsPeer.SCENARIO_ID.equals(name))
        {
            return setByName("ScenarioId", value);
        }
      if (DefaultSimulationSettingsPeer.SIMULATION_START_TIME.equals(name))
        {
            return setByName("SimulationStartTime", value);
        }
      if (DefaultSimulationSettingsPeer.SIMULATION_DURATION.equals(name))
        {
            return setByName("SimulationDuration", value);
        }
      if (DefaultSimulationSettingsPeer.SIMULATION_DT.equals(name))
        {
            return setByName("SimulationDt", value);
        }
      if (DefaultSimulationSettingsPeer.OUTPUT_DT.equals(name))
        {
            return setByName("OutputDt", value);
        }
      if (DefaultSimulationSettingsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (DefaultSimulationSettingsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (DefaultSimulationSettingsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (DefaultSimulationSettingsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (DefaultSimulationSettingsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(DefaultSimulationSettingsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    DefaultSimulationSettingsPeer.doInsert((DefaultSimulationSettings) this, con);
                    setNew(false);
                }
                else
                {
                    DefaultSimulationSettingsPeer.doUpdate((DefaultSimulationSettings) this, con);
                }
            }
     ...
     *
     * @param key scenarioId ObjectKey
     */
    ...
    {
        return SimpleKey.keyFor(getScenarioId());
    }
     ...
     */
    public DefaultSimulationSettings copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public DefaultSimulationSettings copy(Connection con) throws TorqueException
    {
     ...
     */
    public DefaultSimulationSettings copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new DefaultSimulationSettings(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public DefaultSimulationSettings copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new DefaultSimulationSettings(), deepcopy, con);
    }
     ...
     */
    protected DefaultSimulationSettings copyInto(DefaultSimulationSettings copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected DefaultSimulationSettings copyInto(DefaultSimulationSettings copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected DefaultSimulationSettings copyInto(DefaultSimulationSettings copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        copyObj.setScenarioId((Long)null);
     ...
     * @param con the database connection to read associated objects.
     */
    protected DefaultSimulationSettings copyInto(DefaultSimulationSettings copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setScenarioId(scenarioId);
        copyObj.setSimulationStartTime(simulationStartTime);
        copyObj.setSimulationDuration(simulationDuration);
     ...
     */
    public DefaultSimulationSettingsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return DefaultSimulationSettingsPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("DefaultSimulationSettings:\n");
