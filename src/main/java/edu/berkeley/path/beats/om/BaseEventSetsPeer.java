 ...
 *
 */
public abstract class BaseEventSetsPeer
    extends com.relteq.sirius.db.BasePeer
{
     ...
     * @deprecated Torque.getMapBuilder(EventSetsMapBuilder.CLASS_NAME) instead
     */
    public static MapBuilder getMapBuilder()
        throws TorqueException
    {
        return Torque.getMapBuilder(EventSetsMapBuilder.CLASS_NAME);
    }
    ...
    static
    {
        ...
        TABLE_NAME = "event_sets";

        ID = "event_sets.id";
        PROJECT_ID = "event_sets.project_id";
        NAME = "event_sets.name";
        DESCRIPTION = "event_sets.description";
        CREATED = "event_sets.created";
        MODIFIED = "event_sets.modified";
        CREATED_BY = "event_sets.created_by";
        MODIFIED_BY = "event_sets.modified_by";
        MODSTAMP = "event_sets.modstamp";
        if (Torque.isInit())
        {
            try
            {
                Torque.getMapBuilder(EventSetsMapBuilder.CLASS_NAME);
            }
        ...
        {
            Torque.registerMapBuilder(EventSetsMapBuilder.CLASS_NAME);
        }
    }
    ...
    protected static final String CLASSNAME_DEFAULT =
        "com.relteq.sirius.om.EventSets";
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static EventSets row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        try
        {
            EventSets obj = (EventSets) cls.newInstance();
            EventSetsPeer.populateObject(row, offset, obj);
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            ...
            results.add(EventSetsPeer.row2Object(row, 1,
                EventSetsPeer.getOMClass()));
        }
        return results;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(EventSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(EventSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(EventSets obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(EventSets obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(EventSets) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(EventSets obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(EventSets) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(EventSets obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(EventSets) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(EventSets obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( EventSets obj )
    {
    ...
    public static Criteria buildSelectCriteria( EventSets obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     */
    public static EventSets retrieveByPK(Long pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EventSets retrieveByPK(Long pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EventSets retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        EventSets retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static EventSets retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
    ...
    /**
     * selects a collection of EventSets objects pre-filled with their
     * Projects objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EventSetsPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        criteria.addJoin(EventSetsPeer.PROJECT_ID,
            ProjectsPeer.ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            ...
            Class omClass = EventSetsPeer.getOMClass();
            EventSets obj1 = (EventSets) EventSetsPeer
            ...
            {
                EventSets temp_obj1 = (EventSets) results.get(j);
                Projects temp_obj2 = (Projects) temp_obj1.getProjects();
                if (temp_obj2.getPrimaryKey().equals(obj2.getPrimaryKey()))
                {
                    newObject = false;
                    temp_obj2.addEventSets(obj1);
                    break;
                }
            }
            if (newObject)
