...
/**
  ...
  *
  */
public class PostmilesMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.PostmilesMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("postmiles");
        TableMap tMap = dbMap.getTable("postmiles");
        tMap.setJavaName("Postmiles");
        tMap.setOMClass( com.relteq.sirius.om.Postmiles.class );
        tMap.setPeerClass( com.relteq.sirius.om.PostmilesPeer.class );
  ...
  // ------------- Column: node_id --------------------
        ...
        tMap.addColumn(cMap);
  // ------------- Column: highway_id --------------------
        cMap = new ColumnMap( "highway_id", tMap);
        cMap.setType( new Long(0) );
        cMap.setTorqueType( "BIGINT" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(true);
        cMap.setNotNull(false);
        cMap.setJavaName( "HighwayId" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setForeignKey("postmile_highways", "id");
        cMap.setPosition(3);
        tMap.addColumn(cMap);
  // ------------- Column: postmile --------------------
        cMap = new ColumnMap( "postmile", tMap);
        cMap.setType( new BigDecimal((double) 0) );
        cMap.setTorqueType( "DECIMAL" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(true);
        cMap.setJavaName( "Postmile" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setInheritance("false");
        cMap.setSize( 31 );
