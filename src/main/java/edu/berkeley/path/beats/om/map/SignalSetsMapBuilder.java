...
/**
  ...
  *
  */
public class SignalSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.SignalSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("signal_sets");
        TableMap tMap = dbMap.getTable("signal_sets");
        tMap.setJavaName("SignalSets");
        tMap.setOMClass( com.relteq.sirius.om.SignalSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.SignalSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("signal_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("signal_sets");
        }
