...
/**
  ...
  *
  */
public class NodeTypeMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.NodeTypeMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("node_type");
        TableMap tMap = dbMap.getTable("node_type");
        tMap.setJavaName("NodeType");
        tMap.setOMClass( com.relteq.sirius.om.NodeType.class );
        tMap.setPeerClass( com.relteq.sirius.om.NodeTypePeer.class );
