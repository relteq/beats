 ...
 * extended all references should be to SignalSets
 */
public abstract class BaseSignalSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final SignalSetsPeer peer =
        new SignalSetsPeer();
    ...
    {
        getSignalss().add(l);
        l.setSignalSets((SignalSets) this);
    }
     ...
     * Otherwise if this SignalSets has previously
     * been saved, it will retrieve related Signalss from storage.
     * If this SignalSets is new, it will return
    ...
    public List getSignalss(Criteria criteria) throws TorqueException
    {
        if (collSignalss == null)
        {
            ...
            {
                criteria.add(SignalsPeer.SIGNAL_SET_ID, getId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this SignalSets is new, it will return
     * an empty collection; or if this SignalSets has previously
     * been saved, it will retrieve related Signalss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in SignalSets.
     */
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.SIGNAL_SET_ID, getId() );
    ...
    {
        if (name.equals(SignalSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(SignalSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(SignalSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(SignalSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(SignalSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(SignalSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(SignalSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(SignalSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(SignalSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (SignalSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (SignalSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (SignalSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (SignalSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (SignalSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (SignalSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (SignalSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (SignalSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (SignalSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(SignalSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    SignalSetsPeer.doInsert((SignalSets) this, con);
                    setNew(false);
                }
                else
                {
                    SignalSetsPeer.doUpdate((SignalSets) this, con);
                }
            }
     ...
     */
    public SignalSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public SignalSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public SignalSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new SignalSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public SignalSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new SignalSets(), deepcopy, con);
    }
     ...
     */
    protected SignalSets copyInto(SignalSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected SignalSets copyInto(SignalSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected SignalSets copyInto(SignalSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected SignalSets copyInto(SignalSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
    ...
    {
        return SignalSetsPeer.getTableMap();
    }
