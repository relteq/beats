...
/**
  ...
  *
  */
public class SplitRatioProfileSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.SplitRatioProfileSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("split_ratio_profile_sets");
        TableMap tMap = dbMap.getTable("split_ratio_profile_sets");
        tMap.setJavaName("SplitRatioProfileSets");
        tMap.setOMClass( com.relteq.sirius.om.SplitRatioProfileSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.SplitRatioProfileSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("split_ratio_profile_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("split_ratio_profile_sets");
        }
