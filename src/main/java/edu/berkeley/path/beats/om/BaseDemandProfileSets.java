 ...
 * extended all references should be to DemandProfileSets
 */
public abstract class BaseDemandProfileSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final DemandProfileSetsPeer peer =
        new DemandProfileSetsPeer();
    ...
    public void setId(Long v) throws TorqueException
    {
        ...
        if (collDemandProfiless != null)
        {
            for (int i = 0; i < collDemandProfiless.size(); i++)
            {
                ((DemandProfiles) collDemandProfiless.get(i))
                        .setDemandProfileSetId(v);
            }
        }
    ...
    /**
     * Collection to store aggregation of collDemandProfiless
     */
    protected List collDemandProfiless;

    /**
     * Temporary storage of collDemandProfiless to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initDemandProfiless()
    {
        if (collDemandProfiless == null)
        {
            collDemandProfiless = new ArrayList();
        }
    }
     ...
     * @throws TorqueException
     */
    public void addDemandProfiles(DemandProfiles l) throws TorqueException
    {
        getDemandProfiless().add(l);
        l.setDemandProfileSets((DemandProfileSets) this);
    }
     ...
     * @throws TorqueException
     */
    public void addDemandProfiles(DemandProfiles l, Connection con) throws TorqueException
    {
        getDemandProfiless(con).add(l);
        l.setDemandProfileSets((DemandProfileSets) this);
    }

    /**
     * The criteria used to select the current contents of collDemandProfiless
     */
    private Criteria lastDemandProfilessCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getDemandProfiless(new Criteria())
     *
     * @return the collection of associated objects
     * @throws TorqueException
     */
    public List getDemandProfiless()
        throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            collDemandProfiless = getDemandProfiless(new Criteria(10));
        }
        return collDemandProfiless;
    }

    /**
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this DemandProfileSets has previously
     * been saved, it will retrieve related DemandProfiless from storage.
     * If this DemandProfileSets is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getDemandProfiless(Criteria criteria) throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            if (isNew())
            ...
            {
                criteria.add(DemandProfilesPeer.DEMAND_PROFILE_SET_ID, getId() );
                collDemandProfiless = DemandProfilesPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                criteria.add(DemandProfilesPeer.DEMAND_PROFILE_SET_ID, getId());
                if (!lastDemandProfilessCriteria.equals(criteria))
                {
                    collDemandProfiless = DemandProfilesPeer.doSelect(criteria);
                }
            }
        }
        lastDemandProfilessCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getDemandProfiless(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getDemandProfiless(Connection con) throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            collDemandProfiless = getDemandProfiless(new Criteria(10), con);
        }
        return collDemandProfiless;
    }
     ...
     * that is taken as input
     */
    public List getDemandProfiless(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            ...
            {
                 criteria.add(DemandProfilesPeer.DEMAND_PROFILE_SET_ID, getId());
                 collDemandProfiless = DemandProfilesPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this DemandProfileSets is new, it will return
     * an empty collection; or if this DemandProfileSets has previously
     * been saved, it will retrieve related DemandProfiless from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in DemandProfileSets.
     */
    protected List getDemandProfilessJoinDemandProfileSets(Criteria criteria)
        throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            ...
            {
                criteria.add(DemandProfilesPeer.DEMAND_PROFILE_SET_ID, getId());
                collDemandProfiless = DemandProfilesPeer.doSelectJoinDemandProfileSets(criteria);
            }
        }
        else
        {
     ...
     * actually need in DemandProfileSets.
     */
    protected List getDemandProfilessJoinLinkFamiliesRelatedByOriginLinkId(Criteria criteria)
        throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            ...
            {
                criteria.add(DemandProfilesPeer.DEMAND_PROFILE_SET_ID, getId());
                collDemandProfiless = DemandProfilesPeer.doSelectJoinLinkFamiliesRelatedByOriginLinkId(criteria);
            }
        }
        else
        {
     ...
     * actually need in DemandProfileSets.
     */
    protected List getDemandProfilessJoinLinkFamiliesRelatedByDestinationLinkId(Criteria criteria)
        throws TorqueException
    {
        if (collDemandProfiless == null)
        {
            ...
            {
                criteria.add(DemandProfilesPeer.DEMAND_PROFILE_SET_ID, getId());
                collDemandProfiless = DemandProfilesPeer.doSelectJoinLinkFamiliesRelatedByDestinationLinkId(criteria);
            }
        }
        else
        {
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.DEMAND_PROFILE_SET_ID, getId() );
    ...
    {
        if (name.equals(DemandProfileSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(DemandProfileSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(DemandProfileSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(DemandProfileSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(DemandProfileSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(DemandProfileSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(DemandProfileSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(DemandProfileSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(DemandProfileSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (DemandProfileSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (DemandProfileSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (DemandProfileSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (DemandProfileSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (DemandProfileSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (DemandProfileSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (DemandProfileSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (DemandProfileSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (DemandProfileSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(DemandProfileSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    DemandProfileSetsPeer.doInsert((DemandProfileSets) this, con);
                    setNew(false);
                }
                else
                {
                    DemandProfileSetsPeer.doUpdate((DemandProfileSets) this, con);
                }
            }
            ...
            if (collDemandProfiless != null)
            {
                for (int i = 0; i < collDemandProfiless.size(); i++)
                {
                    ((DemandProfiles) collDemandProfiless.get(i)).save(con);
                }
            }
     ...
     */
    public DemandProfileSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public DemandProfileSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public DemandProfileSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new DemandProfileSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public DemandProfileSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new DemandProfileSets(), deepcopy, con);
    }
     ...
     */
    protected DemandProfileSets copyInto(DemandProfileSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected DemandProfileSets copyInto(DemandProfileSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected DemandProfileSets copyInto(DemandProfileSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
        ...
        List vDemandProfiless = getDemandProfiless();
        if (vDemandProfiless != null)
        {
            for (int i = 0; i < vDemandProfiless.size(); i++)
            {
                DemandProfiles obj = (DemandProfiles) vDemandProfiless.get(i);
                copyObj.addDemandProfiles(obj.copy());
            }
        }
        else
        {
            copyObj.collDemandProfiless = null;
        }
     ...
     * @param con the database connection to read associated objects.
     */
    protected DemandProfileSets copyInto(DemandProfileSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
        ...
        List vDemandProfiless = getDemandProfiless(con);
        if (vDemandProfiless != null)
        {
            for (int i = 0; i < vDemandProfiless.size(); i++)
            {
                DemandProfiles obj = (DemandProfiles) vDemandProfiless.get(i);
                copyObj.addDemandProfiles(obj.copy(con), con);
            }
        }
        else
        {
     ...
     */
    public DemandProfileSetsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return DemandProfileSetsPeer.getTableMap();
    }
