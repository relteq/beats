...
/**
  ...
  *
  */
public class RoutesMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.RoutesMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("routes");
        TableMap tMap = dbMap.getTable("routes");
        tMap.setJavaName("Routes");
        tMap.setOMClass( com.relteq.sirius.om.Routes.class );
        tMap.setPeerClass( com.relteq.sirius.om.RoutesPeer.class );
