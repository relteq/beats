 ...
 * extended all references should be to FundamentalDiagramProfileSets
 */
public abstract class BaseFundamentalDiagramProfileSets extends com.relteq.sirius.db.BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1352931909099L;

    /** The Peer class */
    private static final FundamentalDiagramProfileSetsPeer peer =
        new FundamentalDiagramProfileSetsPeer();
        ...
        if (collFundamentalDiagramProfiless != null)
        {
            for (int i = 0; i < collFundamentalDiagramProfiless.size(); i++)
            {
                ((FundamentalDiagramProfiles) collFundamentalDiagramProfiless.get(i))
                        .setFundamentalDiagramProfileSetId(v);
            }
        }
    ...
    public void addFundamentalDiagramProfiles(FundamentalDiagramProfiles l) throws TorqueException
    {
        ...
        l.setFundamentalDiagramProfileSets((FundamentalDiagramProfileSets) this);
    }
     ...
     * Otherwise if this FundamentalDiagramProfileSets has previously
     * been saved, it will retrieve related FundamentalDiagramProfiless from storage.
     * If this FundamentalDiagramProfileSets is new, it will return
    ...
    public List getFundamentalDiagramProfiless(Criteria criteria) throws TorqueException
    {
        if (collFundamentalDiagramProfiless == null)
        {
            ...
            {
                criteria.add(FundamentalDiagramProfilesPeer.FUNDAMENTAL_DIAGRAM_PROFILE_SET_ID, getId() );
     ...
     * If this collection has already been initialized with
     * an identical criteria, it returns the collection.
     * Otherwise if this FundamentalDiagramProfileSets is new, it will return
     * an empty collection; or if this FundamentalDiagramProfileSets has previously
     * been saved, it will retrieve related FundamentalDiagramProfiless from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in FundamentalDiagramProfileSets.
     */
    ...
    public List getScenarioss(Criteria criteria) throws TorqueException
    {
        if (collScenarioss == null)
        {
            ...
            {
                criteria.add(ScenariosPeer.FUNDAMENTAL_DIAGRAM_PROFILE_SET_ID, getId() );
    ...
    {
        if (name.equals(FundamentalDiagramProfileSetsPeer.ID))
        {
            return getId();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.PROJECT_ID))
        {
            return getProjectId();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.NAME))
        {
            return getName();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.DESCRIPTION))
        {
            return getDescription();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.CREATED))
        {
            return getCreated();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.MODIFIED))
        {
            return getModified();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.CREATED_BY))
        {
            return getCreatedBy();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.MODIFIED_BY))
        {
            return getModifiedBy();
        }
        if (name.equals(FundamentalDiagramProfileSetsPeer.MODSTAMP))
        {
            return getModstamp();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (FundamentalDiagramProfileSetsPeer.ID.equals(name))
        {
            return setByName("Id", value);
        }
      if (FundamentalDiagramProfileSetsPeer.PROJECT_ID.equals(name))
        {
            return setByName("ProjectId", value);
        }
      if (FundamentalDiagramProfileSetsPeer.NAME.equals(name))
        {
            return setByName("Name", value);
        }
      if (FundamentalDiagramProfileSetsPeer.DESCRIPTION.equals(name))
        {
            return setByName("Description", value);
        }
      if (FundamentalDiagramProfileSetsPeer.CREATED.equals(name))
        {
            return setByName("Created", value);
        }
      if (FundamentalDiagramProfileSetsPeer.MODIFIED.equals(name))
        {
            return setByName("Modified", value);
        }
      if (FundamentalDiagramProfileSetsPeer.CREATED_BY.equals(name))
        {
            return setByName("CreatedBy", value);
        }
      if (FundamentalDiagramProfileSetsPeer.MODIFIED_BY.equals(name))
        {
            return setByName("ModifiedBy", value);
        }
      if (FundamentalDiagramProfileSetsPeer.MODSTAMP.equals(name))
        {
    ...
    {
        save(FundamentalDiagramProfileSetsPeer.DATABASE_NAME);
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    FundamentalDiagramProfileSetsPeer.doInsert((FundamentalDiagramProfileSets) this, con);
                    setNew(false);
                }
                else
                {
                    FundamentalDiagramProfileSetsPeer.doUpdate((FundamentalDiagramProfileSets) this, con);
                }
            }
     ...
     */
    public FundamentalDiagramProfileSets copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public FundamentalDiagramProfileSets copy(Connection con) throws TorqueException
    {
     ...
     */
    public FundamentalDiagramProfileSets copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new FundamentalDiagramProfileSets(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public FundamentalDiagramProfileSets copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new FundamentalDiagramProfileSets(), deepcopy, con);
    }
     ...
     */
    protected FundamentalDiagramProfileSets copyInto(FundamentalDiagramProfileSets copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected FundamentalDiagramProfileSets copyInto(FundamentalDiagramProfileSets copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected FundamentalDiagramProfileSets copyInto(FundamentalDiagramProfileSets copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setId(id);
     ...
     * @param con the database connection to read associated objects.
     */
    protected FundamentalDiagramProfileSets copyInto(FundamentalDiagramProfileSets copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setId(id);
        copyObj.setProjectId(projectId);
        copyObj.setName(name);
     ...
     */
    public FundamentalDiagramProfileSetsPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return FundamentalDiagramProfileSetsPeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("FundamentalDiagramProfileSets:\n");
        str.append("Id = ")
           .append(getId())
           .append("\n");
