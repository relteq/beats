...
/**
  ...
  *
  */
public class RouteSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.RouteSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("route_sets");
        TableMap tMap = dbMap.getTable("route_sets");
        tMap.setJavaName("RouteSets");
        tMap.setOMClass( com.relteq.sirius.om.RouteSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.RouteSetsPeer.class );
