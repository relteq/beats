...
/**
  ...
  *
  */
public class NetworkConnectionSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.NetworkConnectionSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("network_connection_sets");
        TableMap tMap = dbMap.getTable("network_connection_sets");
        tMap.setJavaName("NetworkConnectionSets");
        tMap.setOMClass( com.relteq.sirius.om.NetworkConnectionSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.NetworkConnectionSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("network_connection_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("network_connection_sets");
        }
