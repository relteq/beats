...
/**
  ...
  *
  */
public class LinkTypeMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.LinkTypeMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("link_type");
        TableMap tMap = dbMap.getTable("link_type");
        tMap.setJavaName("LinkType");
        tMap.setOMClass( com.relteq.sirius.om.LinkType.class );
        tMap.setPeerClass( com.relteq.sirius.om.LinkTypePeer.class );
