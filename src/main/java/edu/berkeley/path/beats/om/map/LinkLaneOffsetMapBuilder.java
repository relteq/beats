...
/**
  ...
  *
  */
public class LinkLaneOffsetMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.LinkLaneOffsetMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("link_lane_offset");
        TableMap tMap = dbMap.getTable("link_lane_offset");
        tMap.setJavaName("LinkLaneOffset");
        tMap.setOMClass( com.relteq.sirius.om.LinkLaneOffset.class );
        tMap.setPeerClass( com.relteq.sirius.om.LinkLaneOffsetPeer.class );
  ...
  // ------------- Column: network_id --------------------
        ...
        cMap.setPosition(2);
        tMap.addColumn(cMap);
  // ------------- Column: display_lane_offset --------------------
        cMap = new ColumnMap( "display_lane_offset", tMap);
        cMap.setType( new BigDecimal((double) 0) );
        cMap.setTorqueType( "DECIMAL" );
        cMap.setUsePrimitive(false);
        cMap.setPrimaryKey(false);
        cMap.setNotNull(false);
        cMap.setJavaName( "DisplayLaneOffset" );
        cMap.setAutoIncrement(false);
        cMap.setProtected(false);
        cMap.setDescription("This parameter indicates how link should be displayed at the map.");
        cMap.setInheritance("false");
        cMap.setSize( 31 );
        cMap.setScale( 16 );
        cMap.setPosition(3);
