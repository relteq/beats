...
/**
  ...
  *
  */
public class InitialDensitySetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.InitialDensitySetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("initial_density_sets");
        TableMap tMap = dbMap.getTable("initial_density_sets");
        tMap.setJavaName("InitialDensitySets");
        tMap.setOMClass( com.relteq.sirius.om.InitialDensitySets.class );
        tMap.setPeerClass( com.relteq.sirius.om.InitialDensitySetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("initial_density_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("initial_density_sets");
        }
