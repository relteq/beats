...
/**
  ...
  *
  */
public class SensorSetsMapBuilder implements MapBuilder
{
    /**
     * The name of this class
     */
    public static final String CLASS_NAME =
        "com.relteq.sirius.om.map.SensorSetsMapBuilder";
    ...
    public synchronized void doBuild() throws TorqueException
    {
        ...
        dbMap.addTable("sensor_sets");
        TableMap tMap = dbMap.getTable("sensor_sets");
        tMap.setJavaName("SensorSets");
        tMap.setOMClass( com.relteq.sirius.om.SensorSets.class );
        tMap.setPeerClass( com.relteq.sirius.om.SensorSetsPeer.class );
        tMap.setPrimaryKeyMethod(TableMap.NATIVE);
        DB dbAdapter = Torque.getDB("sirius");
        if (dbAdapter.getIDMethodType().equals(DB.SEQUENCE))
        {
            tMap.setPrimaryKeyMethodInfo("sensor_sets_SEQ");
        }
        else if (dbAdapter.getIDMethodType().equals(DB.AUTO_INCREMENT))
        {
            tMap.setPrimaryKeyMethodInfo("sensor_sets");
        }
